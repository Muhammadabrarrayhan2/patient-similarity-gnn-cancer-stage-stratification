...
```text
patient-similarity-gnn-cancer-stage-stratification/
│
├── README.md
├── patient_similarity_gnn_cancer_stage_stratification.pdf
├── Untitled16.ipynb
├── data/
│   └── cancer_issue.csv
├── figures/
│   ├── confusion_matrix_stage.png
│   ├── training_curve_stage.png
│   └── graph_subgraph.png
├── results/
│   ├── gnn_predictions_stage.csv
│   └── model_summary_stage.csv
└── src/
    └── main.py
